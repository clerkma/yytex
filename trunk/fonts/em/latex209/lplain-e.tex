...
% 
% File LPLAINEM - For EM fonts - made from lplain.tex for CM fonts
%             - The only change is to \input lfonts => \input lfontsem
%             - Created 29 October 1985 from plain version 1.5CM
...
% \input lfonts	% for CM fonts
\input lfontsem	% for EM fonts
\input latex
