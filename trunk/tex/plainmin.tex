% This is not quite the plain TeX format that's described in The TeXbook.
% Copyright 2007 TeX Users Group.
% You may freely use, modify and/or distribute this file.

% This plainmin.tex has been modified to set up only one font: cmr10
% This file also does not set up any math families.
% The purpose is to conserve math families so that many new ones can be
% defined before running into TeX's limit of 16 math families.
% This means there are initially no math families and you can't typeset any
% math until you load some other macro file like lcdplain.tex or mtplain.tex
% It is assumed that math italic (1), math symbol (2) and math extension (3)
% font families are defined using some such TeX macro file later.
...
% We keep \tenrm since it is used in \footline and \showhyphens,
% though it would be appropriate to change both of them when another
% text font is substituted.
...
% \font\tenbf=cmbx10 % boldface extended (need for \bf)
...
% \font\tentt=cmtt10 % typewriter (need for \tt)
% \font\preloaded=cmtt9
% \font\preloaded=cmtt8

% \font\preloaded=cmsltt10 % slanted typewriter

% \font\tensl=cmsl10 % slanted roman (need for \sl)
% \font\preloaded=cmsl9
% \font\preloaded=cmsl8

% \font\tenit=cmti10 % text italic (need for \it)
...
% leave out \it math family - use \hbox{\sevenit ...} instead 
% \newfam\itfam \def\it{\fam\itfam\tenit} % \it was family 4
\def\it{\tenit} % assuming someone later defines \tenit
% \textfont\itfam=\tenit

% leave out \sl math family - use \hbox{\sevensl ...} instead 
% \newfam\slfam \def\sl{\fam\slfam\tensl} % \sl was family 5
\def\sl{\tensl} % assuming someone later defines \tensl
% \textfont\slfam=\tensl

% we keep \bffam for bold in math (commonly needed) - \tenbf defined later
\newfam\bffam \def\bf{\fam\bffam\tenbf} % \bf was family 6
% \textfont\bffam=\tenbf \scriptfont\bffam=\sevenbf
% \scriptscriptfont\bffam=\fivebf

% leave out \tt math family - use \hbox{\seventt ...} instead 
% \newfam\ttfam \def\tt{\fam\ttfam\tentt} % \tt was family 7
\def\tt{\tentt} % assuming someone later defines \tentt
% \textfont\ttfam=\tentt
...
\newdimen\p@renwd
% \MTEX in mtmacs does the equivalent of the following:
