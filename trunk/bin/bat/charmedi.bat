...
rem Usage: CHARMEDI PFA-file-name [number-of-copies [family-name]]
...
:ps
echo using %1.ps
rem copy %1.ps+c:\ps\copies.ps+c:\ps\params.ps+c:\ps\charmedi.ps %3/b
copy %1.ps+c:\ps\copies.ps+c:\ps\params.ps+c:\ps\charmedi.ps lpt1:/b
goto end

:pfa
echo using %1.pfa
rem copy %1.pfa+c:\ps\copies.ps+c:\ps\params.ps+c:\ps\charmedi.ps %3/b
copy %1.pfa+c:\ps\copies.ps+c:\ps\params.ps+c:\ps\charmedi.ps lpt1:/b
goto end

:hex
echo using %1.hex
rem copy %1.hex+c:\ps\copies.ps+c:\ps\params.ps+c:\ps\charmedi.ps %3/b
