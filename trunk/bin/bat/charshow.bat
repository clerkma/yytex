...
rem Usage: CHARSHOW PFA-file-name [number-of-copies [family-name]]

rem e.g.   charshow tir 10			shows four pages

rem This assumes there is a c:\ps directory with the file charshow.ps in it.
...
rem such as `usehex' `showmac' `shownumeric' `standardfont' in charshow.ps
...
:ps
echo using %1.ps
rem copy %1.ps+c:\ps\copies.ps+c:\ps\params.ps+c:\ps\charshow.ps %3/b
copy %1.ps+c:\ps\copies.ps+c:\ps\params.ps+c:\ps\charshow.ps lpt1:/b
goto end

:pfa
echo using %1.pfa
rem copy %1.pfa+c:\ps\copies.ps+c:\ps\params.ps+c:\ps\charshow.ps %3/b
copy %1.pfa+c:\ps\copies.ps+c:\ps\params.ps+c:\ps\charshow.ps lpt1:/b
goto end

:hex
echo using %1.hex
rem copy %1.hex+c:\ps\copies.ps+c:\ps\params.ps+c:\ps\charshow.ps %3/b
copy %1.hex+c:\ps\copies.ps+c:\ps\params.ps+c:\ps\charshow.ps lpt1:/b
goto end
