...
echo Customization batch file (32 bit) for PFE and WINEDT32 (only!!)

echo.
echo Read user name and serial number (cmbsetup_old) %1 %2 %3 %4 %5 %6 %7 %8 %9 
echo and create c:\yyinstal\serial.ini

echo call cmbsetup_old -d=d: %1 %2 %3 %4 %5 %6 %7 %8 %9 
echo we no longer pause here (except if disk needs to spin up)
if not "%1" == "" call cmbsetup_old -d=d: -e=%1 %2 %3 %4 %5 %6 %7 %8 %9 
if "%1" == "" call cmbsetup_old -d=d: %1 %2 %3 %4 %5 %6 %7 %8 %9 

if not errorlevel == 1 goto doit
echo.
echo Giving up. Some error occured in cmbsetup_old.  
