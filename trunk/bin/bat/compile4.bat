...
rem third arg is stack allocation if default 4000 not OK
...
copydate -v -x c:\prog\%1.exe c:\c\%1.c
...
rem c:\msvc\bin\cl -c -AS -W4 -Ox -Za -Lr -Gr ??? -F %3 c:\c\%1.c
@echo on
c:\msvc\bin\cl -c -AS -W4 -Ox -Za -Lr -Gf -F %3 c:\c\%1.c
@echo off
goto link

:noarg
rem c:\msvc\bin\cl -c -AS -W4 -Ox -Za -Lr -F 4000 c:\c\%1.c
@echo on
c:\msvc\bin\cl -c -AS -W4 -Ox -Za -Lr -Gf -F 4000 c:\c\%1.c
@echo off
:link
