%!
% Beginning of pstricks.pro (tuned for DVIPSONE)
% Copyright 2007 TeX Users Group.
% You may freely use, modify and/or distribute this file.
%
% PostScript prologue for pstricks.tex.
% Created 1994/10/6. Source file was pstricks.doc
% Version 0.93a, 93/03/12.
% For use with DVIPSONE.
...
/STV { 1 dviscl div dup neg scale STP  } def
...
% setmatrix } def
%
% Modification Denis GIROU (CNRS/IDRIS - France) <Denis.Girou@idris.fr> - 3 Sept. 1997
% to make pstricks work with DVIPSONE of Y&Y, Inc.
%suggested change
