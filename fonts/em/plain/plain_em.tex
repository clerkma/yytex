...
% This plain-em.tex has been modified to set up the EM fonts instead of CM.
% Use ini-TeX to create a new `plain-em' TeX format file.

% You can also use the EM fonts with a plain TeX format just by adding
% \input emplain to your source file.
...
\defaulthyphenchar=`\-	% i.e. 45 for OT1 (textext) encoding
% \defaulthyphenchar=127 for T1  (tex256) encoding
% \defaulthyphenchar=173 for LY1 (texnansi) encoding
\defaultskewchar=-1
...
% TeX will not have to reload the font metric information for emr9.
...
% \font\preloaded=emr7 scaled \magstep4 % for titles
% \font\preloaded=emtt10 scaled \magstep2
% \font\preloaded=emssbx10 scaled \magstep2
...
% In CM, the upright upper case Greek letters are in the text font!
...
\def\fmtname{plain-em}\def\fmtversion{3.141592} % identifies the current format
